...
import aboutTop from "@/public/about-1.jpg";
import aboutBottom from "@/public/about-2.jpg";
...
export default async function Page() {
    ...
    return (
        <>
            ...
            <div className="flex flex-col-reverse lg:flex-row-reverse gap-10 lg:gap-20 mt-10 lg:mt-20">
                <div className="w-full lg:w-[57%]">
                    <h1 className="text-4xl mb-10 text-accent-400 font-medium">
